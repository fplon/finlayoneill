...
export function CvTitleLinks(): JSX.Element {
  return (
    <header className="mb-8 border-b border-gray-200 pb-6 print:border-b print:pb-3 print:mb-4">
      <h1 className="text-3xl sm:text-4xl font-bold text-gray-800 print:text-2xl">
        Finlay O&apos;Neill
      </h1>
      <div className="text-sm text-gray-600 mt-3 print:text-xs print:mt-2 inline-flex items-center flex-wrap gap-x-2 gap-y-1">
