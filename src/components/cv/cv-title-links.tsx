...
export function CvTitleLinks(): JSX.Element {
  return (
    <header className="mb-8 border-b border-gray-200 pb-6 print:mb-4 print:pb-3">
      ...
      <div className="text-sm text-gray-600 mt-3 w-full flex justify-center items-center flex-wrap gap-x-2 gap-y-1 print:mt-1 print:text-xs print:gap-x-1.5">
      ...
      <div className="text-sm text-gray-600 mt-1 w-full flex justify-center items-center flex-wrap gap-x-2 gap-y-1 print:text-xs print:gap-x-1.5">
        <a
